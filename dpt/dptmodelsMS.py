...
class DPTMS(BaseModel):
    ...
    def forward(self, x):
        ...
        disp4=self.scratch.output_conv4(path_4)
        path_3 = self.scratch.refinenet3(path_4, layer_3_rn)
        disp3=self.scratch.output_conv3(path_3)
        path_2 = self.scratch.refinenet2(path_3, layer_2_rn)
        disp2=self.scratch.output_conv2(path_2)
