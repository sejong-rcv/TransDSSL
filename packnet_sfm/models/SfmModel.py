...
class SfmModel(BaseModel):
    ...
    def depth_net_flipping(self, batch, flip, epoch=0):
        """
    ...
    def compute_depth_net(self, batch, force_flip=False, epoch=0):
        ...
        output = self.depth_net_flipping(batch, flag_flip_lr, epoch=epoch)
    ...
    def forward(self, batch, return_logs=False, force_flip=False, epoch=0):
        """
        Processes a batch.
        ...
        depth_output = self.compute_depth_net(batch, force_flip=force_flip, epoch=epoch)
