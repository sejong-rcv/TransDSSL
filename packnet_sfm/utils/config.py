...
def parse_train_file(file):
    ...
    # file = "/workspace/packnet-sfm_jmshin/checkpoint/Swin-S_imagenet_randinit_2layer_v1.0.7/epoch=11_KITTI_raw-eigen_test_files-velodyne-loss=0.000.ckpt"
    # file = "/workspace/packnet-sfm_jmshin/checkpoint/Swin-S_imagenet_randinit_2layer_v1.0.1/epoch=29_KITTI_raw-eigen_test_files-velodyne-loss=0.000.ckpt"
